 ...
 */
final class AddDeviceAppUserProcessor extends AbstractAppUserProcessor implements AppUserProcessorInterface
{
    /**
     * @inheritDoc
     *
    ...
    {
        return AppUserProcessorInterface::ADD_DEVICE_APP_USER_PROCESSOR === $processor;
    }
}
