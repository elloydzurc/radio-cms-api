...
/**
 * Class DeleteFavoriteAppUserProcessor
 *
 * @package App\Services\Api\AppUser\Processors
 */
final class DeleteFavoriteAppUserProcessor extends AbstractAppUserProcessor implements AppUserProcessorInterface
{
    /**
     * @inheritDoc
     *
    ...
    public function process(AbstractDto $data): ResponseInterface
    {
        ...
        $this->appUserRepository->deleteFavorite($appUser, $data->getContentId());
    ...
    {
        return AppUserProcessorInterface::DELETE_FAVORITE_APP_USER_PROCESSOR === $processor;
    }
}
