...
use App\Services\Api\Station\Transformers\StationWithFeaturedContentTransformer;

/**
 * Class FeaturedContentStationProcessor
 *
 * @package App\Services\Api\Station\Processors
 */
final class FeaturedContentStationProcessor extends AbstractStationProcessor implements StationProcessorInterface
{
    /**
     * @inheritDoc
     *
    ...
    {
        $paginator = $this->stationRepository->featuredContentStation($data);
        $entities = $paginator->getCollection();

        return new DefaultResponse($entities, StationWithFeaturedContentTransformer::class, $paginator);
    }
    ...
    {
        return StationProcessorInterface::FEATURED_CONTENT_STATION_PROCESSOR === $processor;
    }
}
